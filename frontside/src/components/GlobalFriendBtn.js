...
const GlobalFriendBtn = ({ className, user }) => {
  ...
  return (
    <>
      {friend ? (
        <button className={className} onClick={handleRemoveFriend} style={{ backgroundColor: 'crimson' }}>
          Unfriend
        </button>
      ) : (
        <button className={className} onClick={handleAddFriend}>
          Add Friend
        </button>
      )}
    </>
